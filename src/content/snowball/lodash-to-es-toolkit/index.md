...
- **`_.chain`**: method chaining. This pattern fell out of style and es-toolkit doesn't include it, so use native array methods or plain function composition instead.
- **`_.template`**: string template compilation. Rarely used in modern code, and if you need it, keep it as a direct Lodash import.
